import { Home, Building2, FileText, PlayCircle, ClipboardList, Gauge, Shield, Users, User, Receipt, FileBarChart, LayoutDashboard } from "lucide-react";
          ...
          <SidebarGroup>
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton isActive={currentPath === "/hytrack"} disabled className="opacity-50 cursor-not-allowed">
                    <FileBarChart className="h-4 w-4" />
                    <span>HyTrack Form</span>
                  </SidebarMenuButton>
                </SidebarMenuItem>
              </SidebarMenu>
            </SidebarGroupContent>
